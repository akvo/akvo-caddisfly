...
public class CalibrateListFragment extends ListFragment {
    ...
    void setAdapter() {
        ...
        assert mainApp != null;
        CalibrateListAdapter customList = new CalibrateListAdapter(getActivity(), mainApp.currentTestInfo.getRanges().toArray(new ResultRange[mainApp.currentTestInfo.getRanges().size()]));
