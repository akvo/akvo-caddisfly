package akvo.org.akvocst.calibration;

import android.content.Context;

import akvo.org.akvocst.AssetsManager;
...
public class CalibrationCard{
    ...
    public static CalibrationData readCalibrationFile(Context context){
        ...
        String calFileName = "calibration.json";
    ...
    * Calibrate an image using a 3-step process. The steps are:
     ...
     */
    public static CalibrationResultData calibrateImage(Mat labImg, Context context) throws Exception{
