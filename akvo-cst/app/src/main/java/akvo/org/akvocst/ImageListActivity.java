...
public class ImageListActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportFragmentManager().beginTransaction().replace(R.id.frameLayout, imageListFragment).commit();
    ...
    public void onItemSelected(int position) {
        if (mTwoPane) {
            ...
            arguments.putInt(ImageDetailFragment.ARG_ITEM_ID, position);
            ...
            detailIntent.putExtra(ImageDetailFragment.ARG_ITEM_ID, position);
